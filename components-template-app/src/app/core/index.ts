export { MessagesMenuComponent } from './top-navbar/messages-menu/messages-menu.component';
export { MessagesMenuService } from './top-navbar/messages-menu/messages-menu.service';

export { NotificationsMenuButtonComponent } from './top-navbar/notifications-menu/button/notifications-menu-button.component';
export { NotificationsMenuContentComponent } from './top-navbar/notifications-menu/content/notifications-menu-content.component';
export { NotificationsMenuService } from './top-navbar/notifications-menu/notifications-menu.service';
...
export { Error404PageResolver } from './404/error-404-page.resolver';
